      ...
      <div className="relative z-10 flex w-full max-w-4xl overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-900/80 backdrop-blur-xl">
        ...
        <div className="flex w-full items-center justify-center p-8 lg:w-1/2">
          <div className="w-full max-w-sm">
            ...
            <p className="mt-1 text-sm text-neutral-400">Sign in to enter the arena.</p>
            ...
            <p className="mt-6 text-center text-sm text-neutral-400">
              No account? <a className="font-semibold text-emerald-400 hover:underline transition-colors" href="/signup">Create one</a>
            </p>
          </div>
        </div>
      </div>
